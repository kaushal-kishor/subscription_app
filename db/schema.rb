...
ActiveRecord::Schema.define(version: 20171026082825) do
  ...
  add_index "spree_orders_subscriptions", ["order_id"], name: "index_spree_orders_subscriptions_on_order_id", using: :btree
  add_index "spree_orders_subscriptions", ["subscription_id"], name: "index_spree_orders_subscriptions_on_subscription_id", using: :btree
  ...
  add_index "spree_product_subscription_frequencies", ["product_id"], name: "index_spree_product_subscription_frequencies_on_product_id", using: :btree
  ...
  add_index "spree_products", ["is_subscribable"], name: "index_spree_products_on_is_subscribable", using: :btree
  ...
  add_index "spree_subscriptions", ["bill_address_id"], name: "index_spree_subscriptions_on_bill_address_id", using: :btree
  add_index "spree_subscriptions", ["cancelled_at"], name: "index_spree_subscriptions_on_cancelled_at", using: :btree
  add_index "spree_subscriptions", ["parent_order_id"], name: "index_spree_subscriptions_on_parent_order_id", using: :btree
  add_index "spree_subscriptions", ["paused"], name: "index_spree_subscriptions_on_paused", using: :btree
  add_index "spree_subscriptions", ["plan_id"], name: "index_spree_subscriptions_on_plan_id", using: :btree
  add_index "spree_subscriptions", ["ship_address_id"], name: "index_spree_subscriptions_on_ship_address_id", using: :btree
  add_index "spree_subscriptions", ["subscribed_at"], name: "index_spree_subscriptions_on_subscribed_at", using: :btree
  add_index "spree_subscriptions", ["subscription_frequency_id"], name: "index_spree_subscriptions_on_subscription_frequency_id", using: :btree
  add_index "spree_subscriptions", ["unsubscribed_at"], name: "index_spree_subscriptions_on_unsubscribed_at", using: :btree
  add_index "spree_subscriptions", ["variant_id"], name: "index_spree_subscriptions_on_variant_id", using: :btree
